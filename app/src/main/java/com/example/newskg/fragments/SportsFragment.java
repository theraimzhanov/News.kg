...
public class SportsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerViewSports = getActivity().findViewById(R.id.recyclerSports);
        list = new ArrayList<>();
        ...
        recyclerViewSports.setLayoutManager(new LinearLayoutManager(getActivity()));
        RetrofitBuilder.getService().getAllNews("sports",data,"popularity","fdc952d04aa64ed4be22bd6c1e870552").enqueue(new Callback<News>() {
            @Override
